...
SAND_RECLAIM_RATE = 0.05        # Sand becomes dirt near water — used by zones.py off-screen sim
SAND_RAIN_RECLAIM_RATE = 0.04   # Sand near water → dirt during rain only (oasis/puddle forming)
