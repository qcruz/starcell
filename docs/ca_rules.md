...
| GRASS/SAND/DIRT → other base type | inline | 1× | 0.0001 × _decay | 3+ neighbors of a different base terrain type; converts to that type |
...
| Base terrain pressure | inline | 0.0001 × _decay | Any GRASS/SAND/DIRT with 3+ neighbors of a different base type → converts to that type |
