...
| DIRT → SAND (desert reclamation) | `DIRT_TO_SAND_DESERT_RATE` | 1× | 0.0001 × _decay | biome = DESERT, 3+ sand neighbors |
...
| DIRT → SAND (reclamation) | `DIRT_TO_SAND_DESERT_RATE` | 0.0001 × _decay | desert biome, 3+ sand neighbors |
